...
function ten (operation) { return operation ? operation(10) : 10 }
...
/* 
The arithmetic operations plus, minus, times, and dividedBy are also defined as functions 
that take number a and return another function. The returned function takes number b
and performs the specified arithmetic operation on a and b. 
For example, the plus function returns a function that takes a number a and returns the sum of a and b (i.e., a + b).
*/
